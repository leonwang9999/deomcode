...
public class Util {
	...
	private List<Contact> getListContactsFromJSON(Object data){
		...
		List<Contact> newContacts = (List<Contact>) JSONArray.toList(jsonArray,Contact.class);
	...
	public List<Integer> getListIdFromJSON(Object data){
		JSONArray jsonArray = JSONArray.fromObject(data);
		List<Integer> idContacts = (List<Integer>) JSONArray.toList(jsonArray,Integer.class);
		return idContacts;
	}
}
